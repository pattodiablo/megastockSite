...
<div class="container-fluid">
	...
	<div class="row show-on-scroll">
		...
		<div class="col-md-10" style="margin-top: 6rem"><img class="img-fluid"  src="<?php echo(base_url());?>images/7QuienesSomos/7_QuienesSomos_Banner.png"></div>
		<div class="col-md-1"></div>
	</div>
	...
	<div class="row show-on-scroll p-6 "> 
			...
			<div class="col-lg-4" style="text-align: center">
				...
				<p style="color: #f37021; font-size: 2.5rem; font-family: 'Playfair Display', serif; margin-top: -1.5rem">Asegura su éxito</p>
				<p style="color: #323232; font-size: 1rem; font-weight: bold; margin-top: 1.3rem">En la actualidad vemos imprescindible acoplarse a las exigencias del sector, pues la calidad, rapidez, confiabilidad, son elementos que van implícitos dentro de cada producto que brindamos.</p>
	...
	<div class="row show-on-scroll p-6" style="background-color: #ffa400; padding-top: 2rem; padding-bottom: 2rem;"> 
		...
		<p>
		este es nuestro compromiso hacia ustedes, 	
		</p>
