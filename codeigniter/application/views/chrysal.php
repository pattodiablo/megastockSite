...
<div class="container-fluid">
	...
	<div class="row show-on-scroll">
		...
		<div class="col-md-10" style="margin-top: 6rem"><img class="img-fluid"  src="<?php echo(base_url());?>images/4LineaChrysal/4_LineaChrysal_Banner.png"></div>
		<div class="col-md-1"></div>
	</div>
	...
	<div class="row show-on-scroll p-6 "> 
			...
			<div class="col-lg-4" style="text-align: center">
				...
				<p style="color: #527bbd; font-size: 1.5rem; font-weight: bold; margin-top: 2.5rem">Línea</p>
				<p style="color: #0037a9; font-size: 3rem; font-family: 'Playfair Display', serif; margin-top: -1.7rem">Chrysal</p>
				<p style="color: #527bbd; font-size: 1.5rem; font-weight: bold; margin-top: -1.7rem">Distribuidor en Ecuador</p>
